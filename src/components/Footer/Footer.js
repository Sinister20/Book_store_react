      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            ...
            <p>
            BookStore application were you can find your favourote book.
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            ...
            <p>
              <a href="https://sinister-portfolio.netlify.app/">Portfolio</a>
            </p>
            <p>
              <a href="https://www.linkedin.com/in/sanchit-srivastava-5612ba197/">LinkedIn</a>
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> sanchit.srivastava207@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 7318256405
            </p>
           </MDBCol>
        </MDBRow>
        <hr />
